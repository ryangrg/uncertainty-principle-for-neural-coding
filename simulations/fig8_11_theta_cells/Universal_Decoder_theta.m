...
%     drawnow;
        ...
        ThetaSpikes = PlacePhaseBurstGenerator(ihd(trainrange), itpos(trainrange), ncells, [1:(ncells-1)]/2, basefrequency, .12); %create spike trains
        ...
        ThetaSpikes = PlacePhaseBurstGenerator(ihd(testrange), itpos(testrange), ncells, [1:(ncells-1)]/2, basefrequency, .12); %create spike trains
