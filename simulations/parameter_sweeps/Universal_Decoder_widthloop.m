...
%    dfh = designfilt('bandpassiir', 'StopbandFrequency1', cf*.1, 'PassbandFrequency1', cf*.2, 'PassbandFrequency2', cf*1.8, 'StopbandFrequency2', cf*1.9, 'StopbandAttenuation1', 30, 'PassbandRipple', 1, 'StopbandAttenuation2', 30, 'SampleRate', 30);
    dfh = designfilt('bandpassiir', 'StopbandFrequency1', .01, 'PassbandFrequency1', .02, 'PassbandFrequency2', 1.5*1.8, 'StopbandFrequency2', 1.5*1.9, 'StopbandAttenuation1', 30, 'PassbandRipple', 1, 'StopbandAttenuation2', 30, 'SampleRate', 30);
    bpav=filtfilt(dfh,av*.75);
    figure(1); clf;
    subplot(2,1,1);
